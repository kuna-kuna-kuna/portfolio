import Yummee from "./assets/yummee_logo.png";
import Securaze from "./assets/securaze.png";
import CloudMedify from "./assets/cloud_medify.svg";
import Proptrak from "./assets/logo.png";
...
export const Data = [
  ...
  },
  {
    ...
    image: Proptrak,
    description:
      "The real estate application allows users to view, schedule, purchase, or list their properties. It has both a web and mobile version, with the frontend developed using React.js for the web and React Native.js with Expo for the mobile app.",
    languages: [
      "React.js",
      "SASS",
      "Javascript",
